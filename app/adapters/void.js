...
export default ApplicationAdapter.extend({
    ...
    buildURL: function(type, id) {
        Ember.Logger.debug('void adapter information:');
        var url = this.host + "/" + this.namespace + "/authorization/" + id + "/" + type;
        Ember.Logger.debug('  void adapter, url = ' + url);
        return url;
    },
    ...
    createRecord: function(store, type, record) {
        ...
        data = data.void; //Customization here.  Only send the payment.  Not the wrapped payment.
