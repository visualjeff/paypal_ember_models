...
export default DS.RESTSerializer.extend({
    ...
    extractMeta: function(store, type, payload) {
        Ember.Logger.debug('amount extractMeta invoked!');
    },


    //To tweak what your sending to the server
    serialize: function(record, options) {
        Ember.Logger.debug('amount serialize invoked!');
        var json = this._super(record, options);
        //Ember.Logger.debug('  amount json = ' + JSON.stringify(json));
        return json;
    },
    /*
    ...
    */
    serializeBelongsTo: function(record, json, relationship) {
        Ember.Logger.debug('amount serializeBelongsTo invoked!');
    ...
    serializeHasMany: function(record, json, relationship) {
        //Ember.Logger.debug('amount serializeHasMany invoked!');
        var key = relationship.key,
            property = Ember.get(record, key),
            relationshipType = DS.RelationshipChange.determineRelationshipType(record.constructor, relationship);
        //Ember.Logger.debug('  key = ' + key);
    ...
    keyForAttribute: function(attr) {
        Ember.Logger.debug('amount keyForAttribute invoked!');
    ...
    extract: function(store, type, payload, id, requestType) {
        Ember.Logger.debug('amount extract invoked!');
    ...
    extractSingle: function(store, type, payload) {
        Ember.Logger.debug('amount extracSingle invoked!');
        Ember.Logger.debug('  type = ' + JSON.stringify(type));
        Ember.Logger.debug('  payload = ' + JSON.stringify(payload));
    ...
    normalize: function(type, hash, prop) {
        Ember.Logger.debug('amount normalize invoked!');
        Ember.Logger.debug('  type = ' + JSON.stringify(type));
    ...
    normalizePayload: function(payload) {
        Ember.Logger.debug('amount normalizePayload invoked!');
        return this._super(payload);
    },

    normalizeId: function(hash) {
        Ember.Logger.debug('amount normalizeId invoked!');
        return this._super(hash);
    },

    normalizeAttributes: function(type, hash) {
        Ember.Logger.debug('amount normalizeAttributes invoked!');
        return this._super(type, hash);
    },

    normalizeRelationships: function(type, hash) {
        Ember.Logger.debug('amount normalizeRelationships invoked!');
        return this._super(type, hash);
    },

    normalizeUsingDeclaredMapping: function(type, hash) {
        Ember.Logger.debug('amount normalizeUsingDeclaredMapping invoked!');
        return this._super(type, hash);
    },

    applyTransforms: function(type, data) {
        Ember.Logger.debug('amount applyTransforms invoked!');
        Ember.Logger.debug('  type = ' + JSON.stringify(type));
