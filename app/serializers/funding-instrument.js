...
export default DS.RESTSerializer.extend({
    ...
    keyForAttribute: function(attr) {
        Ember.Logger.debug('fundingInstrument keyForAttribute invoked!');
    ...
    extractSingle: function(store, type, payload) {
        Ember.Logger.debug('fundingInstrument extracSingle invoked!');
        Ember.Logger.debug('  type = ' + JSON.stringify(type));
        Ember.Logger.debug('  payload = ' + JSON.stringify(payload));
    ...
    normalize: function(type, hash, prop) {
        Ember.Logger.debug('fundingInstrument normalize invoked!');
        Ember.Logger.debug('  type = ' + JSON.stringify(type));
    ...
    normalizeId: function(hash) {
        Ember.Logger.debug('fundingInstrument normalizeId invoked!');
        return this._super(hash);
    },

    normalizeAttributes: function(type, hash) {
        Ember.Logger.debug('fundingInstrument normalizeAttributes invoked!');
        return this._super(type, hash);
    },

    normalizeRelationships: function(type, hash) {
        Ember.Logger.debug('fundingInstrument normalizeRelationships invoked!');
        return this._super(type, hash);
    },

    normalizeUsingDeclaredMapping: function(type, hash) {
        Ember.Logger.debug('fundingInstrument normalizeUsingDeclaredMapping invoked!');
        return this._super(type, hash);
    },

    applyTransforms: function(type, data) {
        Ember.Logger.debug('fundingInstrument applyTransforms invoked!');
        Ember.Logger.debug('  type = ' + JSON.stringify(type));
